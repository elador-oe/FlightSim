...
import models.PlaneStatusModel;
...
public class ViewModel extends Observable implements Observer {
	...
	PlaneStatusModel airplaneModel;
	...
	public ViewModel(MatrixModel matrixModel, PlaneStatusModel airplaneModel, ConnectModel connectModel) {
	...
	public void update(Observable o, Object arg) {
		...
		if (o == airplaneModel) {
			this.airplanePositionX.set(airplaneModel.getPlanePosition().x);
			this.airplanePositionY.set(airplaneModel.getPlanePosition().y);
